...
public class ValidatorService {
    ...
    private static Pattern patternNameValidation = Pattern.compile("[A-Za-zА-Яа-я0-9- ]*");
    ...
    private static Pattern patternBookEditionValidation = Pattern.compile("[A-Za-zА-Яа-я0-9#?!@$%^&* -]*");
    ...
    public ValidationData validate(LoginForm form) {
        ValidationData validationData = new ValidationData();
        validationData.setValidationResult(true);
    ...
    public ValidationData validate(AdminEditBookForm form) {
        ...
        matcher = patternBookEditionValidation.matcher(form.getBookEdition());
        if (!matcher.matches()) {
